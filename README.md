...
![Salute](./media/github-header-banner.png)

<br/>

I am a **Senior Software Engineer** with over 10 years of experience in software development and technical leadership, specializing in **digital commerce** and, more recently, **backend engineering for insurance & financial services**. Currently a **Senior Backend Engineer @Nationale-Nederlanden (NN Group)**, working with Node.js, TypeScript and AWS. Previously, as Tech Lead, I led teams of up to 14 developers and delivered VTEX-based digital commerce solutions for multinational clients such as Hunter Douglas, Whirlpool, Unilever, Reckitt, Danone and Belcorp.
